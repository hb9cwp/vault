...
`SEPIOR_USER_ID` and `SEPIOR_PASSWORDS` as part of the seal's parameters,
...
from AWS KMS:
  https://raw.githubusercontent.com/hashicorp/vault/main/website/content/docs/configuration/seal/awskms.mdx 
